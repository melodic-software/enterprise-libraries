    ...
    where TCommand : IBaseCommand
{
    ...
    /// </summary>
    internal Func<IServiceProvider, IHandleCommand<TCommand>>? CommandHandlerFactory { get; }

    public RegistrationOptions(Func<IServiceProvider, IHandleCommand<TCommand>>? factory)
    {
