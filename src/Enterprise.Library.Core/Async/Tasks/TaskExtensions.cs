...
public static class TaskExtensions
{
    ...
    public static async Task WhenAllAsync(this IEnumerable<Task> tasks) => await Task.WhenAll(tasks.ToArray());
    public static async Task WhenAnyAsync(this IEnumerable<Task> tasks) => await Task.WhenAny(tasks.ToArray());
}
