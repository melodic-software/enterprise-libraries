...
public static class GlobalErrorHandler
{
    ...
    private static JsonSerializerOptions JsonSerializerOptions => GetJsonSerializerOptions();

    internal static async Task HandleErrorAsync(HttpContext context, Exception exception)
    {
    ...
    private static async Task UseSimpleErrorAsync(HttpContext context, Exception exception, ILogger logger)
    {
        ...
        var errorDetailsDto = new ErrorDetailsDto(context.Response.StatusCode, ErrorMessage);
        ...
        logger.LogError(eventId, exception, "{ExceptionMessage}", exception.Message);
    }
